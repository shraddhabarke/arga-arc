...
class TestVocabFactory(unittest.TestCase):
    ...
    def test_create(self):
        all_transform_classes = [Color, UpdateColor, MoveNode, ExtendNode, MoveNodeMax, RotateNode, AddBorder, FillRectangle, HollowRectangle, Insert, Mirror, Flip] # Transforms
